...
public class magma_dripper extends EntityMob implements CustomEntity {
    public final static CustomEntityDefinition def = CustomEntityDefinition.builder().identifier("dm2:magma_dripper")
            .summonable(true)
            .spawnEgg(false)
            .build();

    public magma_dripper(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
