...
public class yeti extends EntityMob implements CustomEntity {
    ...
    public final static CustomEntityDefinition def = CustomEntityDefinition.builder().identifier("mlcs:yeti")
            .summonable(true)
            .spawnEgg(false)
            .build();
    public yeti(FullChunk chunk, CompoundTag nbt) {
        super(chunk, nbt);
    }
    @Override
